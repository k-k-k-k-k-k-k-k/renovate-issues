...
terraform {
  source = "ssh://git@gitlab.com/gitlab-com/gl-infra/gitlab-dedicated/library/terraform/cloudwatch_log_export?ref=1.6.5"
}

# long url-style SSH address
terraform {
  source = "git::ssh://git@gitlab.com/gitlab-com/gl-infra/gitlab-dedicated/library/terraform/cloudwatch_log_export?ref=1.6.5"
}
